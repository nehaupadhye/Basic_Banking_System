<?php
session_start();
$con=mysqli_connect("localhost","id16171693_root","Upadhye@1234","id16171693_banking_system") or die(mysqli_error($con));
...
<thead>
		<th><b style="color:red; font-size:20px;">SENDER</b></th>
                                      <th><b style="color:red; font-size:20px;">RECEIVER</b></th>
		<th><b style="color:red; font-size:20px;">BALANCE</b></th>
	</thead>
	<tbody>
<tr>
        <?php  
